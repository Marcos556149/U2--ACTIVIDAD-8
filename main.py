...
#-------------------------------------------------# 
    ...
    tiempoPac = 1      #Tiempo de llegada a cola de turnos
...
#-------------------------------------------------#
    colaTurnos=Cola()     #Cola de llegada para solicitar turnos
    colasEspecialidades=[]          #Lista de colas para cada consultorio
    for i in range(4):
        colasEspecialidades.append(Cola())    #Agrega en la lista las colas para cada consultorio
#-------------------------------------------------#
...
#-------------------------------------------------# 
    ...
    while i <= Simulacion:
        if i <=60:      #TIEMPO DE ATENCION DE MESA DE ENTRADA
            ...
            if 1/tiempoPac == 1 /random.randint(1,tiempoPac):
                nombre = 'Paciente '+str(contCola+1)
                dni = random.randint(7000000,44000000)
                posicion=random.randint(0,len(esp)-1)   ##elige una posicion al azar de la lista de especialidades
